...
export default function InboxPirataListPage() {
            ...
            <main className={styles.mainContent}>
                ...
                <div style={{ padding: 24 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
                        <div>
                            <h1 style={{ fontSize: '1.75rem', fontWeight: 700, margin: 0 }}>Meus Inboxes Free</h1>
                    ...
                    {loading ? (
                        ...
                        <div style={{ 
                            ...
                            <p style={{ color: '#64748B', margin: '0 0 24px 0' }}>
                                Crie seu primeiro inbox para conectar um WhatsApp
                            </p>
                            <button
                                onClick={handleCreateInbox}
                                disabled={creating}
                        ...
                        <div style={{ 
                            ...
                            {inboxes.map((inbox) => (
                                <div
                                    key={inbox.id}
                                    onClick={() => router.push(`/atendente/inbox-pirata/${inbox.id}`)}
                                    style={{
                                        background: 'white',
                                        borderRadius: 12,
                                        padding: 20,
